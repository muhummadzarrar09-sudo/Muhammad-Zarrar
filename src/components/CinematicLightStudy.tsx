  ...
  return (
    <group ref={group}>
      <mesh>
        ...
        <meshPhongMaterial color="#f4f1ea" emissive="#ff6a3d" emissiveIntensity={0.42} shininess={105} flatShading={false} />
      </mesh>
      <mesh rotation={[0.6, 1.4, 0.9]}>
        <torusKnotGeometry args={[0.58, 0.19, 48, 10, 2, 3]} />
        <meshPhongMaterial color="#ff6a3d" emissive="#1c1914" emissiveIntensity={0.28} shininess={85} flatShading={false} />
      </mesh>
      {[0, 1, 2, 3].map((i) => (
        <mesh
          key={i}
          position={[Math.cos(i * 1.85 + 0.8) * 1.72, Math.sin(i) * 0.92, Math.sin(i * 1.4) * 0.6]}
      ...
      <mesh position={[0, 1.1, 0]}>
        <torusGeometry args={[0.72, 0.015, 10, 24]} />
...
export default CinematicLightStudy;
